function [ map1,map2,map3,map4 ] = mani_version_MDMV( Ws,Wd,Wp,Z,mu,dn1,dn2,dn3,dn4 )
...
map3=ev(dn1+dn2+1:dn1+dn2+dn3,idx);
map4=ev(dn1+dn2+dn3+1:dn1+dn2+dn3+dn4,idx);
